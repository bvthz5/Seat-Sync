...
import { Building2, Layers, DoorOpen, Armchair, AlertCircle, GraduationCap, ChevronLeft } from 'lucide-react';
 ...
 *
 * The existing, fully working College Structure page, now mounted at:
 *   /admin/college-structure/endsem
 *
 * All original logic is preserved exactly as-is.
 * DO NOT mix Internal structure logic into this page.
 */
const EndSemCollegeStructurePage: React.FC = () => {
    const { user } = useAuth();
        ...
        <div className="min-h-screen bg-slate-50/50 pb-12">
            ...
            <div className="pt-6 px-8 max-w-[1920px] mx-auto flex flex-col gap-2">
                ...
                <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center shadow-sm shadow-purple-200">
                        <GraduationCap size={18} className="text-white" />
                    </div>
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">
                            End Semester College Structure
                        </h1>
                        <p className="text-slate-500 text-sm font-medium">
                            Configure blocks, floors, rooms, and seating layouts.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-3 flex items-center gap-3 text-amber-800 animate-in fade-in slide-in-from-top-2 duration-300 max-w-2xl">
                        ...
                        <div>
                            ...
                            <p className="text-xs opacity-90">
                                You are viewing this configuration in read-only mode. Only Root Admins can make changes.
                            </p>
                        </div>
                    </div>
                )}
            ...
            <div className="px-8 py-6 max-w-[1920px] mx-auto">
                ...
                {selectedTab === "layout" && (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <LayoutConfig readOnly={isReadOnly} singleSeatOnly={true} />
                    </div>
                )}
            </div>
        </div>
...
export default EndSemCollegeStructurePage;
