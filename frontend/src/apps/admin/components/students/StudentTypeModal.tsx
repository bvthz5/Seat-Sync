...
import { GraduationCap, Tag, X, ArrowRight, ShieldCheck, Users } from "lucide-react";
...
const StudentTypeModal: React.FC<StudentTypeModalProps> = ({ isOpen, onClose }) => {
            ...
            <ModalContent>
                <ModalHeader className="flex flex-col gap-1.5">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-[0.2em] text-indigo-500/80">Management Portal</span>
                        <div className="w-8 h-1 bg-indigo-500 rounded-full" />
                    </div>
                    <h2 className="text-3xl font-black text-slate-900 tracking-tight leading-tight">Student <span className="text-indigo-600">Portal</span></h2>
                </ModalHeader>
                <ModalBody>
                    <div className="grid grid-cols-2 gap-8">
                        {/* Internal Option - Now First */}
                        <button 
                            onClick={() => handleSelect('/admin/students/internal')}
                        ...
                        >
                            ...
                            <h3 className="text-xl font-black text-slate-900 leading-tight group-hover:text-violet-600 transition-colors px-2">Internal Exams</h3>
                        ...
                        <button 
                            onClick={() => handleSelect('/admin/students/endsem')}
                        ...
                        >
                            ...
                            <h3 className="text-xl font-black text-slate-900 leading-tight group-hover:text-indigo-600 transition-colors px-2">End Semester</h3>
